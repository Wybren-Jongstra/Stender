...
class AddForeignKeysToCONNECTIONTable extends Migration {
	...
	public function up()
	{
		Schema::table('CONNECTION', function(Blueprint $table)
		{
			...
			$table->foreign('ConnectionKindID', 'fk_CONNECTION_CONNECTION_KIND1')->references('ConnectionKindID')->on('CONNECTION_KIND')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('CONNECTION', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_CONNECTION_CONNECTION_KIND1');
